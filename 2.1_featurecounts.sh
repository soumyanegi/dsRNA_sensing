...
samples="/camhpc/ngs/projects/TST11724/scripts/sample_sheet_V79.txt"
bam_dir="/camhpc/ngs/projects/TST11724/DNANexus/20210317213939/sort_bams"
...
output="/camhpc/ngs/projects/TST11724/counts_mRNAseq/DNANexus_20210317213939_2"

cd $bam_dir

date
while read line; do
	bamqis=$bam_dir/TST11580_"$line".genome.sorted.bam
	...
	featureCounts -O -T 16 -F GTF -a $GTF_FILE -t exon -g gene_id -s $STRAND $PAIRS $FEATURECOUNTS_OVERLAP -o $output/"$line".mRNA.V79_AAV-amiR-SOD1.counts.txt $bamqis
